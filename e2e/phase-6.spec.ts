...
/**
 * Номер дня недели в понимании ряда: 0 — воскресенье, 6 — суббота, как
 * `weekday` в `src/lib/time.ts` и как `CHECK` в `rotation_rows`.
 *
 * Раньше здесь воскресенье превращалось в 7, которого в списке дней нет:
 * приёмка выбирала несуществующий вариант и висела до таймаута. Молчало
 * это шесть дней в неделю и срабатывало в воскресенье — 27 сентября 2026
 * прогон встал именно на этом.
 */
